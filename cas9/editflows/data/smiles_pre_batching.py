...
CSV_PATH = os.path.join(PROJECT_ROOT, "data/smiles/28k_mimetics.csv")
SMILES_COL = "Peptidomimetic_SMILES"
OUTPUT_DIR = os.path.join(PROJECT_ROOT, "data/smiles/28k_mimetics")
...
# 2) Tokenizer
# ------------------------------------------------------------
tokenizer = SMILES_SPE_Tokenizer(os.path.join(PROJECT_ROOT, 'smiles_tokenizer/new_vocab.txt'),
                                 os.path.join(PROJECT_ROOT, 'smiles_tokenizer/new_splits.txt'))
