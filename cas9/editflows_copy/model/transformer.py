...
import sys
import os
# Add flow_matching to path if needed for imports
_flow_matching_dir = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), 'flow_matching')
if _flow_matching_dir not in sys.path:
    sys.path.insert(0, _flow_matching_dir)
